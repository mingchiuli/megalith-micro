...
public record BlogSensitiveContentRpcVo(Long blogId, List<SensitiveContentRpcVo> sensitiveContent) {
  ...
  public static class BlogSensitiveContentDtoBuilder {
    ...
    public BlogSensitiveContentDtoBuilder sensitiveContent(
        List<SensitiveContentRpcVo> sensitiveContentRpcVo) {
