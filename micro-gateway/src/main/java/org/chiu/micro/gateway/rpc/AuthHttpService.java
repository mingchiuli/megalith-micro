...
public interface AuthHttpService {
    ...
    Result<AuthorityRouteDto> getAuthorityRoute(@RequestBody AuthorityRouteReq req, @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false, defaultValue = "") String token);
}
