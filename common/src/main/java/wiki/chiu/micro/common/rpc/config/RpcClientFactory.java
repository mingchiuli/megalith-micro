...
public class RpcClientFactory {
    ...
    public static  <T> T createHttpService(Class<T> serviceClass, String url, HttpClient httpClient, HttpInterceptor interceptor, DefaultUriBuilderFactory.EncodingMode encodingMode, HttpHeaders headers) {
