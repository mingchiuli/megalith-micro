...
public class UserEntityVoConvertor {
  ...
  public static PageAdapter<UserEntityVo> convert(
      Page<UserEntity> page, List<UserRoleEntity> userRoleEntities, List<RoleEntity> roleEntities) {
    ...
    Map<Long, LocalDateTime> userDate =
        page.get().collect(Collectors.toMap(UserEntity::getId, UserEntity::getUpdated));
