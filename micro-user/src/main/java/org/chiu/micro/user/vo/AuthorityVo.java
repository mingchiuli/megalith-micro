...
public class AuthorityVo {
    ...
    AuthorityVo(Long id, String name, String code, String remark, String prototype, String methodType, String routePattern, String serviceHost, Integer servicePort, LocalDateTime created, LocalDateTime updated, Integer status) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.remark = remark;
    ...
    public static class AuthorityVoBuilder {
        ...
        public AuthorityVo build() {
            return new AuthorityVo(this.id, this.name, this.code, this.remark, this.prototype, this.methodType, this.routePattern, this.serviceHost, this.servicePort, this.created, this.updated, this.status);
        }

        public String toString() {
            return "AuthorityVo.AuthorityVoBuilder(id=" + this.id + ", name=" + this.name + ", code=" + this.code + ", remark=" + this.remark + ", prototype=" + this.prototype + ", methodType=" + this.methodType + ", routePattern=" + this.routePattern + ", serviceHost=" + this.serviceHost + ", servicePort=" + this.servicePort + ", created=" + this.created + ", updated=" + this.updated + ", status=" + this.status + ")";
        }
    }
}
