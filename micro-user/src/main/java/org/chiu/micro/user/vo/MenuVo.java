...
public class MenuVo {
    ...
    MenuVo(Long menuId, Long parentId, String title, String name, String url, String component, Integer type, String icon, Integer orderNum, Integer status, List<MenuVo> children) {
        this.menuId = menuId;
    ...
    private static List<MenuVo> $default$children() {
    ...
    public String toString() {
        return "MenuVo(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ", children=" + this.getChildren() + ")";
    }
    ...
    public static class MenuVoBuilder {
        ...
        private Integer orderNum;
        private Integer status;
        private List<MenuVo> children$value;
        ...
        public MenuVo build() {
            List<MenuVo> children$value = this.children$value;
            if (!this.children$set) {
                children$value = MenuVo.$default$children();
            }
            return new MenuVo(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status, children$value);
        }

        public String toString() {
            return "MenuVo.MenuVoBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ", children$value=" + this.children$value + ")";
        }
    }
}
