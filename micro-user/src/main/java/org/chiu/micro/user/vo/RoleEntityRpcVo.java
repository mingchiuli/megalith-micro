...
public class RoleEntityRpcVo {
    ...
    RoleEntityRpcVo(Long id, String name, String code, String remark, LocalDateTime created, LocalDateTime updated, Integer status) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.remark = remark;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RoleEntityRpcVo)) return false;
        final RoleEntityRpcVo other = (RoleEntityRpcVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RoleEntityRpcVo;
    }
    ...
    public String toString() {
        return "RoleEntityRpcVo(id=" + this.getId() + ", name=" + this.getName() + ", code=" + this.getCode() + ", remark=" + this.getRemark() + ", created=" + this.getCreated() + ", updated=" + this.getUpdated() + ", status=" + this.getStatus() + ")";
    }
    ...
    public static class RoleEntityRpcVoBuilder {
        ...
        public RoleEntityRpcVo build() {
            return new RoleEntityRpcVo(this.id, this.name, this.code, this.remark, this.created, this.updated, this.status);
        }

        public String toString() {
            return "RoleEntityRpcVo.RoleEntityRpcVoBuilder(id=" + this.id + ", name=" + this.name + ", code=" + this.code + ", remark=" + this.remark + ", created=" + this.created + ", updated=" + this.updated + ", status=" + this.status + ")";
        }
    }
}
