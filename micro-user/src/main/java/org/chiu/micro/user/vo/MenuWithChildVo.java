...
public class MenuWithChildVo {
    ...
    MenuWithChildVo(Long menuId, Long parentId, String title, String name, String url, String component, Integer type, String icon, Integer orderNum, Integer status, List<MenuWithChildVo> children) {
        this.menuId = menuId;
    ...
    private static List<MenuWithChildVo> $default$children() {
    ...
    public List<MenuWithChildVo> getChildren() {
    ...
    public void setChildren(List<MenuWithChildVo> children) {
        this.children = children;
    }

    public boolean equals(final Object o) {
        if (o == this) return true;
        if (!(o instanceof MenuWithChildVo)) return false;
        final MenuWithChildVo other = (MenuWithChildVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MenuWithChildVo;
    }
    ...
    public String toString() {
        return "MenuWithChildVo(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ", children=" + this.getChildren() + ")";
    }
    ...
    public static class MenuWithChildVoBuilder {
        ...
        private Integer orderNum;
        private Integer status;
        private List<MenuWithChildVo> children$value;
        private boolean children$set;

        MenuWithChildVoBuilder() {
        }
        ...
        public MenuWithChildVo build() {
            List<MenuWithChildVo> children$value = this.children$value;
            if (!this.children$set) {
                children$value = MenuWithChildVo.$default$children();
            }
            return new MenuWithChildVo(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status, children$value);
        }

        public String toString() {
            return "MenuWithChildVo.MenuWithChildVoBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ", children$value=" + this.children$value + ")";
        }
    }
}
