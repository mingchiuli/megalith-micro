...
public class MenuEntity {
    ...
    public boolean equals(final Object o) {
        ...
        final MenuEntity other = (MenuEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MenuEntity;
    }
    ...
    public String toString() {
        return "MenuEntity(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ", created=" + this.getCreated() + ", updated=" + this.getUpdated() + ")";
    }
    ...
    public static class MenuEntityBuilder {
        ...
        public MenuEntity build() {
            return new MenuEntity(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status, this.created, this.updated);
        }

        public String toString() {
            return "MenuEntity.MenuEntityBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ", created=" + this.created + ", updated=" + this.updated + ")";
        }
    }
}
