...
public class AuthorityEntityReq {
    ...
    public @NotBlank String getRemark() {
        return this.remark;
    }

    public @NotBlank String getPrototype() {
        return this.prototype;
    }

    public @NotBlank String getMethodType() {
        return this.methodType;
    }

    public @NotBlank String getRoutePattern() {
        return this.routePattern;
    }

    public @NotBlank String getServiceHost() {
        return this.serviceHost;
    }

    public @NotBlank String getServicePort() {
    ...
    public void setRemark(@NotBlank String remark) {
        this.remark = remark;
    }

    public void setPrototype(@NotBlank String prototype) {
        this.prototype = prototype;
    }

    public void setMethodType(@NotBlank String methodType) {
        this.methodType = methodType;
    }

    public void setRoutePattern(@NotBlank String routePattern) {
        this.routePattern = routePattern;
    }

    public void setServiceHost(@NotBlank String serviceHost) {
        this.serviceHost = serviceHost;
    }

    public void setServicePort(@NotBlank String servicePort) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AuthorityEntityReq)) return false;
        final AuthorityEntityReq other = (AuthorityEntityReq) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AuthorityEntityReq;
    }
    ...
    public String toString() {
        return "AuthorityEntityReq(id=" + this.getId() + ", name=" + this.getName() + ", code=" + this.getCode() + ", remark=" + this.getRemark() + ", prototype=" + this.getPrototype() + ", methodType=" + this.getMethodType() + ", routePattern=" + this.getRoutePattern() + ", serviceHost=" + this.getServiceHost() + ", servicePort=" + this.getServicePort() + ", status=" + this.getStatus() + ")";
    }
}
