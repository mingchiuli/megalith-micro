...
public class MenuEntityVo {
    ...
    MenuEntityVo(Long menuId, Long parentId, String title, String name, String url, String component, Integer type, String icon, Integer orderNum, Integer status) {
        this.menuId = menuId;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MenuEntityVo)) return false;
        final MenuEntityVo other = (MenuEntityVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MenuEntityVo;
    }
    ...
    public String toString() {
        return "MenuEntityVo(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ")";
    }
    ...
    public static class MenuEntityVoBuilder {
        ...
        public MenuEntityVo build() {
            return new MenuEntityVo(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status);
        }

        public String toString() {
            return "MenuEntityVo.MenuEntityVoBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ")";
        }
    }
}
