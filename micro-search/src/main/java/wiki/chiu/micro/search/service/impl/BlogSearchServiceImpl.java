...
public class BlogSearchServiceImpl implements BlogSearchService {
  ...
  @Override
  public PageAdapter<BlogDocumentVo> selectBlogsByES(
      Integer currentPage, String keywords, Boolean allInfo) {
    NativeQuery matchQuery =
        PublicSearchQueryConvertor.searchConvert(keywords, currentPage, blogPageSize, allInfo);
    SearchHits<@NonNull BlogDocument> search =
        elasticsearchTemplate.search(matchQuery, BlogDocument.class);
  ...
  public void addReadCount(Long id) {
    var updateQuery =
        UpdateQuery.builder(id.toString())
