...
public class PublicSearchQueryConvertor {
  ...
  public static NativeQuery searchConvert(
      String keywords, Integer currentPage, Integer blogPageSize, Boolean allInfo) {
                                                            ...
                                                            ScriptSource.of(
                                                                builder ->
                                                                    builder.scriptString(
                                                                        "def c = doc['readCount'].value;return Math.log(c + 3);")))
                ...
                ? new HighlightQuery(
                    new Highlight(
                        new HighlightParameters.HighlightParametersBuilder()
                            ...
                            .build(),
                        List.of(
                            new HighlightField(TITLE.getField()),
