...
@Table(
    name = "m_outbox_event",
    indexes = {
        @Index(name = "idx_outbox_poll", columnList = "producer,state,available_at"),
        @Index(
            name = "idx_outbox_aggregate",
            columnList = "producer,aggregate_type,aggregate_id,id"),
        @Index(name = "idx_outbox_manage", columnList = "producer,event_id")
    })
