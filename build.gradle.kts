...
plugins {
    ...
    id("org.hibernate.orm") version "7.4.1.Final" apply false
}
...
subprojects {
    ...
    configure<DependencyManagementExtension> {
        dependencies {
            dependency("org.redisson:redisson:4.6.0")
            dependency("com.nimbusds:nimbus-jose-jwt:10.9.1")
            dependency("wiki.chiu.megalith:cache-spring-boot-starter:4.6.0")
        }
    }
