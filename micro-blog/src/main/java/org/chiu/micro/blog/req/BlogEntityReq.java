...
public class BlogEntityReq {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BlogEntityReq)) return false;
        final BlogEntityReq other = (BlogEntityReq) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BlogEntityReq;
    }
    ...
    public String toString() {
        return "BlogEntityReq(id=" + this.getId() + ", title=" + this.getTitle() + ", description=" + this.getDescription() + ", content=" + this.getContent() + ", status=" + this.getStatus() + ", link=" + this.getLink() + ", sensitiveContentList=" + this.getSensitiveContentList() + ")";
    }
}
