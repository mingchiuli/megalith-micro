...
public class BlogSensitiveContentDto {
    ...
    BlogSensitiveContentDto(Long blogId, List<String> sensitiveContent) {
        this.blogId = blogId;
    ...
    public List<String> getSensitiveContent() {
    ...
    public void setSensitiveContent(List<String> sensitiveContent) {
        this.sensitiveContent = sensitiveContent;
    }
