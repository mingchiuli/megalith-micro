...
public class BlogRoutes {
    ...
    public static RouterFunction<ServerResponse> routes(BlogHttpHandler blogHandler,
        ...
        return withDefaultErrorHandling(route()
                ...
                .GET("/sys/blog/lock/{blogId}", blogHandler::setBlogToken)
                .GET("/sys/blog/blogs", blogHandler::getAllBlogs)
                .GET("/sys/blog/deleted", blogHandler::getDeletedBlogs)
                .GET("/sys/blog/recover/{idx}", blogHandler::recoverDeletedBlog)
                ...
                .POST("/inner/blog/{blogId}", internalHandler::setReadCount), log)
                .build();
    }
}
