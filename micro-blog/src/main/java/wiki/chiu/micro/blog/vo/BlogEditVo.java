...
public record BlogEditVo(
  ...
  public static class BlogEditVoBuilder {
    ...
    private BlogPermissionsVo permissions;
    ...
    public BlogEditVoBuilder permissions(BlogPermissionsVo permissions) {
      this.permissions = permissions;
      return this;
    }

    public BlogEditVo build() {
      return new BlogEditVo(
          id, userId, title, description, link, content, status, sensitiveContentList, permissions);
    }
  }

  // 敏感内容DTO
  public record SensitiveContentVo(Integer startIndex, Integer endIndex, Integer type) {
    ...
    public record SensitiveContentVoBuilder(Integer startIndex, Integer endIndex, Integer type) {
      public SensitiveContentVoBuilder() {
        this(null, null, null);
      }

      public BlogEditVo.SensitiveContentVo.SensitiveContentVoBuilder startIndex(
          Integer startIndex) {
        return new BlogEditVo.SensitiveContentVo.SensitiveContentVoBuilder(
