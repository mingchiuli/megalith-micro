...
public class UserRedisCacheEvictMessageListener {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(UserRedisCacheEvictMessageListener.class);
  ...
  public UserRedisCacheEvictMessageListener(
      CacheEvictHandler cacheEvictHandler, CommonCacheKeyGenerator commonCacheKeyGenerator) {
  ...
  private void addRoleBasedAuthKeys(List<String> roles, Set<String> keys)
      throws NoSuchMethodException {
    Method getAuthoritiesByRoleCodeMethod =
        AuthWrapper.class.getMethod("getAuthoritiesByRoleCode", String.class);
    roles.forEach(
        role ->
