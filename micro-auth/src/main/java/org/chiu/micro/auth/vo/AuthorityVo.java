...
public class AuthorityVo {
    ...
    AuthorityVo(Long id, String name, String code, String remark, String prototype, String methodType, String routePattern, String serviceHost, Integer servicePort, Integer status) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.remark = remark;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AuthorityVo)) return false;
        final AuthorityVo other = (AuthorityVo) o;
    ...
    public String toString() {
        return "AuthorityVo(id=" + this.getId() + ", name=" + this.getName() + ", code=" + this.getCode() + ", remark=" + this.getRemark() + ", prototype=" + this.getPrototype() + ", methodType=" + this.getMethodType() + ", routePattern=" + this.getRoutePattern() + ", serviceHost=" + this.getServiceHost() + ", servicePort=" + this.getServicePort() + ", status=" + this.getStatus() + ")";
    }
    ...
    public static class AuthorityVoBuilder {
        ...
        public AuthorityVo build() {
            return new AuthorityVo(this.id, this.name, this.code, this.remark, this.prototype, this.methodType, this.routePattern, this.serviceHost, this.servicePort, this.status);
        }

        public String toString() {
            return "AuthorityVo.AuthorityVoBuilder(id=" + this.id + ", name=" + this.name + ", code=" + this.code + ", remark=" + this.remark + ", prototype=" + this.prototype + ", methodType=" + this.methodType + ", routePattern=" + this.routePattern + ", serviceHost=" + this.serviceHost + ", servicePort=" + this.servicePort + ", status=" + this.status + ")";
        }
    }
}
