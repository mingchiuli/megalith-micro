...
public class ButtonVo {
    ...
    ButtonVo(Long menuId, Long parentId, String title, String name, String url, String component, Integer type, String icon, Integer orderNum, Integer status) {
        this.menuId = menuId;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ButtonVo)) return false;
        final ButtonVo other = (ButtonVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ButtonVo;
    }
    ...
    public String toString() {
        return "ButtonVo(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ")";
    }
    ...
    public static class ButtonVoBuilder {
        ...
        public ButtonVo build() {
            return new ButtonVo(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status);
        }

        public String toString() {
            return "ButtonVo.ButtonVoBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ")";
        }
    }
}
