...
public class MenuWithChildRpcDto {
    ...
    MenuWithChildRpcDto(Long menuId, Long parentId, String title, String name, String url, String component, Integer type, String icon, Integer orderNum, Integer status, List<MenuWithChildRpcDto> children) {
        this.menuId = menuId;
    ...
    private static List<MenuWithChildRpcDto> $default$children() {
        return new ArrayList<>();
    }

    public static MenuWithChildRpcDtoBuilder builder() {
        return new MenuWithChildRpcDtoBuilder();
    }
    ...
    public List<MenuWithChildRpcDto> getChildren() {
    ...
    public void setChildren(List<MenuWithChildRpcDto> children) {
        this.children = children;
    }

    public boolean equals(final Object o) {
        if (o == this) return true;
        if (!(o instanceof MenuWithChildRpcDto)) return false;
        final MenuWithChildRpcDto other = (MenuWithChildRpcDto) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MenuWithChildRpcDto;
    }
    ...
    public String toString() {
        return "MenuWithChildRpcDto(menuId=" + this.getMenuId() + ", parentId=" + this.getParentId() + ", title=" + this.getTitle() + ", name=" + this.getName() + ", url=" + this.getUrl() + ", component=" + this.getComponent() + ", type=" + this.getType() + ", icon=" + this.getIcon() + ", orderNum=" + this.getOrderNum() + ", status=" + this.getStatus() + ", children=" + this.getChildren() + ")";
    }
    ...
    public static class MenuWithChildRpcDtoBuilder {
        ...
        private Integer orderNum;
        private Integer status;
        private List<MenuWithChildRpcDto> children$value;
        private boolean children$set;

        MenuWithChildRpcDtoBuilder() {
        }
        ...
        public MenuWithChildRpcDto build() {
            List<MenuWithChildRpcDto> children$value = this.children$value;
            if (!this.children$set) {
                children$value = MenuWithChildRpcDto.$default$children();
            }
            return new MenuWithChildRpcDto(this.menuId, this.parentId, this.title, this.name, this.url, this.component, this.type, this.icon, this.orderNum, this.status, children$value);
        }

        public String toString() {
            return "MenuWithChildRpcDto.MenuWithChildRpcDtoBuilder(menuId=" + this.menuId + ", parentId=" + this.parentId + ", title=" + this.title + ", name=" + this.name + ", url=" + this.url + ", component=" + this.component + ", type=" + this.type + ", icon=" + this.icon + ", orderNum=" + this.orderNum + ", status=" + this.status + ", children$value=" + this.children$value + ")";
        }
    }
}
