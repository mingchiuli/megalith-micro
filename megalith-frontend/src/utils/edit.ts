...
export const watchInput = (form: EditForm, pushActionForm: PushActionForm, opreateStatus: OpreateStatusParam) => {
...
const preCheck = (n: string | undefined, o: string | undefined, opreateStatus: OpreateStatusParam): boolean => {
...
const commonPreDeal = (fieldTypeParam: FieldType, opreateField: FieldName, form: EditForm, pushActionForm: PushActionForm, opreateStatus: OpreateStatusParam) => {
...
const deal = (n: string | undefined, o: string | undefined, opreateStatus: OpreateStatusParam, pushActionForm: PushActionForm, form: EditForm) => {
